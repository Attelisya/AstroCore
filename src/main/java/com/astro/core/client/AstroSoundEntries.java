...
public class AstroSoundEntries {
    ...
    public static final SoundEntry GLACIODILLO_AMBIENT = REGISTRATE.sound(AstroCore.id("entity.glaciodillo.ambient"))
            .build();
    public static final SoundEntry GLACIODILLO_DEATH = REGISTRATE.sound(AstroCore.id("entity.glaciodillo.death"))
            .build();
    public static final SoundEntry GLACIODILLO_HURT = REGISTRATE.sound(AstroCore.id("entity.glaciodillo.hurt")).build();
    public static final SoundEntry GLACIODILLO_HURT_REDUCED = REGISTRATE
            .sound(AstroCore.id("entity.glaciodillo.hurt_reduced")).build();
    ...
    public static final SoundEntry GLACIODILLO_UNROLL_FINISH = REGISTRATE
            .sound(AstroCore.id("entity.glaciodillo.unroll_finish")).build();
    public static final SoundEntry GLACIODILLO_UNROLL_START = REGISTRATE
            .sound(AstroCore.id("entity.glaciodillo.unroll_start")).build();
