...
public class IndustrialCokeOvenMachine extends WorkableMultiblockMachine implements IDisplayUIMachine, IFancyUIMachine {
    ...
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            IndustrialCokeOvenMachine.class, WorkableMultiblockMachine.MANAGED_FIELD_HOLDER);
    ...
    public IndustrialCokeOvenMachine(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    }
    ...
    public static ModifierFunction recipeModifier(MetaMachine machine, @Nonnull GTRecipe recipe) {
        if (machine instanceof IndustrialCokeOvenMachine ico) {
    ...
    public void addDisplayText(@NotNull List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("astrogreg.multiblock.industrial_coke_oven.speed",
